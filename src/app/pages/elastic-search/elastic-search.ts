...
@Component({
    ...
    standalone: true,
    imports: [IonicModule, NgIf, FormsModule, NgFor, NgSwitch, NgSwitchCase, NgSwitchDefault, RouterLink, DateHistogram, NgStyle, AsyncPipe, ElasticHitCollectionPagePathPipe, ElasticHitCollectionPageQueryparamsPipe]
})
